...
<div class="wrapper" id="app">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      A full featured laravel web application
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a href="https://adminlte.io">Lara start</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
